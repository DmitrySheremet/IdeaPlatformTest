package com.ideaplatformtest.ui.theme
...
//  LocalContext.current.findActivity()?.window?.apply {
//    statusBarColor = systemBarColor.toArgb()
//    navigationBarColor = systemBarColor.toArgb()
